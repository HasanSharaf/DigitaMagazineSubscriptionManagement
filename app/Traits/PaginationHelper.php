...
trait PaginationHelper
{
    ...
    public function getPaginatedData(array $headers, $data, $resource, $includeIndex = false): array
    {

        return ['headers' => $headers, 'data' => $this->prepareData($data, $resource, $includeIndex)];
    }
